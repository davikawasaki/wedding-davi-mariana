...
function AboutUs() {
  return (
    <section className="about-us block pt-48 w-11/12 px-40" id="about-us">
      <h2 className="mb-20 text-9xl text-center capitalize">Sobre Nós</h2>
      <div className="bride flex mb-20">
        <div className="bride-image ml-2 mt-4 w-6/12 border-8 border-orange-800 relative"></div>
        <div className="bride-text w-7/12 ml-32">
      ...
      <div className="groom flex mb-20">
        <div className="groom-text w-7/12 mr-32">
        ...
        <div className="groom-image mr-2 mb-4 w-6/12 border-8 border-orange-800 relative"></div>
      </div>
    </section>
  );
}
